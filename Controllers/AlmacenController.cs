     ...
     [HttpPost("InsertAlmacen")]
        public IActionResult InsertAlmacen([FromBody] InsertAlmacenModel req )
        {
            ...
            try
            {
                ...
                objectResponse.message = "Almacen registrado correctamente";
        ...
        public IActionResult GetAlmacen()
        {
            ...
            try
            {
                ...
                objectResponse.success = true;
                objectResponse.message = "Almacenes cargados con exito";
        ...
        public IActionResult UpdateAlmacen([FromBody] UpdateAlmacenModel req )
        {
            ...
            try
            {
                objectResponse.StatusCode = (int)HttpStatusCode.Created;
                objectResponse.success = true;
                objectResponse.message = "Almacen actualizado correctamente";
        ...
        public IActionResult DeleteAlmacen([FromQuery] int Id )
        {
            ...
            try
            {
                objectResponse.StatusCode = (int)HttpStatusCode.Created;
                objectResponse.success = true;
                objectResponse.message = "Almacen eliminado correctamente";
